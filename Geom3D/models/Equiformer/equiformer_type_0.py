...
class EquiformerEnergy(torch.nn.Module):
    def __init__(self,
        irreps_in='5x0e',
        irreps_node_embedding='128x0e+64x1e+32x2e', node_class=119, num_layers=6,
        ...
        self.atom_embed = NodeEmbeddingNetwork(self.irreps_node_embedding, self.node_class)
...
def Equiformer_l2(irreps_in, radius, num_basis, node_class, **kwargs):
    model = EquiformerEnergy(
        irreps_in=irreps_in,
        irreps_node_embedding='128x0e+64x1e+32x2e', node_class=node_class, num_layers=6,
        irreps_node_attr='1x0e', irreps_sh='1x0e+1x1e+1x2e',
        max_radius=radius,
...
def Equiformer_nonlinear_l2_e3(irreps_in, radius, num_basis, node_class, **kwargs):
    model = EquiformerEnergy(
        irreps_in=irreps_in,
        irreps_node_embedding='128x0e+32x0o+32x1e+32x1o+16x2e+16x2o', node_class=node_class, num_layers=6,
...
def Equiformer_nonlinear_bessel_l2(irreps_in, radius, num_basis, node_class, **kwargs):
    model = EquiformerEnergy(
        irreps_in=irreps_in,
        irreps_node_embedding='128x0e+64x1e+32x2e', node_class=node_class, num_layers=6,
        irreps_node_attr='1x0e', irreps_sh='1x0e+1x1e+1x2e',
...
def Equiformer_nonlinear_bessel_l2_drop01(irreps_in, radius, num_basis, node_class, **kwargs):
    model = EquiformerEnergy(
        irreps_in=irreps_in,
        irreps_node_embedding='128x0e+64x1e+32x2e', node_class=node_class, num_layers=6,
        irreps_node_attr='1x0e', irreps_sh='1x0e+1x1e+1x2e',
...
def Equiformer_nonlinear_bessel_l2_drop00(irreps_in, radius, num_basis, node_class, **kwargs):
    model = EquiformerEnergy(
        irreps_in=irreps_in,
        irreps_node_embedding='128x0e+64x1e+32x2e', node_class=node_class, num_layers=6,
        irreps_node_attr='1x0e', irreps_sh='1x0e+1x1e+1x2e',
